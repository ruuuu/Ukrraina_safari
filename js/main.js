$(function () {
	...
	}); // для слайдера https://kenwheeler.github.io/slick/
	...
	$('.gallery__item-inner').magnificPopup({ // взяла отсюда  https://dimsemenov.com/plugins/magnific-popup/ жмем на lightBox Gallery
		delegate: 'a',
		type: 'image',
		tLoading: 'Loading image #%curr%...',
		mainClass: 'mfp-img-mobile',
